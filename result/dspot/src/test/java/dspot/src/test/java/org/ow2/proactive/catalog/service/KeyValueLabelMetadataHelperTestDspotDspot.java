...
public class KeyValueLabelMetadataHelperTestDspotDspot {
    ...
    public void testThatGetOnlyGenericInformationIsOnlyReturningGenericInformation_mg2() throws java.lang.Exception {
        org.ow2.proactive.catalog.repository.entity.KeyValueLabelMetadataEntity __DSPOT_o_5822 = new org.ow2.proactive.catalog.repository.entity.KeyValueLabelMetadataEntity("O?ibS/CD[_A-{sef|0|>", "KajcA7wJB#<|Heo|OEtT", "0J*v8H#g*#na-9|te@B4");
