...
public class KeyValueLabelMetadataHelperTestDspotDspot {
    ...
    public void testThatGetOnlyGenericInformationIsOnlyReturningGenericInformation_mg2() throws java.lang.Exception {
        org.ow2.proactive.catalog.repository.entity.KeyValueLabelMetadataEntity __DSPOT_o_5656 = new org.ow2.proactive.catalog.repository.entity.KeyValueLabelMetadataEntity("x#TJuh_^0)3u]Ma-0l3h", ",n)[8!gUIm]7scxtS:7m", "0aoK[--f_eVR7)d]J=e4");
        ...
        boolean o_testThatGetOnlyGenericInformationIsOnlyReturningGenericInformation_mg2__10 = keyValueLabelMetadataEntityAnythingElse.equals(__DSPOT_o_5656);
        com.google.common.truth.Truth.assertThat(o_testThatGetOnlyGenericInformationIsOnlyReturningGenericInformation_mg2__10).isFalse();
    }
