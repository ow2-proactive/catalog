...
public class BucketServiceTestDspot {
    ...
    public void testCreateBucket_mg1_mg16() throws java.lang.Exception {
        ...
        org.ow2.proactive.catalog.repository.entity.CatalogObjectEntity __DSPOT_catalogObject_428 = new org.ow2.proactive.catalog.repository.entity.CatalogObjectEntity();
        ...
        mockedBucket.addCatalogObject(__DSPOT_catalogObject_428);
        boolean o_testCreateBucket_mg1_mg16__35 = __DSPOT_catalogObject_428.equals(__DSPOT_o_433);
        org.junit.Assert.assertFalse(o_testCreateBucket_mg1_mg16__35);
    }

    @org.junit.Test(timeout = 10000)
    public void testCreateBucket_mg2_mg17() throws java.lang.Exception {
        org.ow2.proactive.catalog.repository.entity.BucketEntity __DSPOT_o_433 = new org.ow2.proactive.catalog.repository.entity.BucketEntity("S#|+j^,pi4ZW!0^5@t*x", "Ih#U7W%TLWr&k[nEeaf<");
        org.ow2.proactive.catalog.repository.entity.BucketEntity __DSPOT_o_429 = new org.ow2.proactive.catalog.repository.entity.BucketEntity();
        org.ow2.proactive.catalog.repository.entity.BucketEntity mockedBucket = newMockedBucket(1L, "bucket-name", java.time.LocalDateTime.now());
        org.mockito.Mockito.when(bucketRepository.save(org.mockito.Matchers.any(org.ow2.proactive.catalog.repository.entity.BucketEntity.class))).thenReturn(mockedBucket);
        org.mockito.Mockito.when(bucketNameValidator.isValid(org.mockito.Matchers.anyString())).thenReturn(true);
        org.ow2.proactive.catalog.dto.BucketMetadata bucketMetadata = bucketService.createBucket("BUCKET-NAME-TEST", org.ow2.proactive.catalog.service.BucketServiceTestDspot.DEFAULT_BUCKET_NAME);
        org.ow2.proactive.catalog.repository.entity.BucketEntity o_testCreateBucket_mg2__16 = org.mockito.Mockito.verify(bucketRepository, org.mockito.Mockito.times(1)).save(org.mockito.Matchers.any(org.ow2.proactive.catalog.repository.entity.BucketEntity.class));
        boolean o_testCreateBucket_mg2__20 = org.mockito.Mockito.verify(bucketNameValidator, org.mockito.Mockito.times(1)).isValid(org.mockito.Matchers.anyString());
        mockedBucket.getBucketName();
        bucketMetadata.getName();
        mockedBucket.getOwner();
        bucketMetadata.getOwner();
        boolean o_testCreateBucket_mg2__28 = mockedBucket.equals(__DSPOT_o_429);
        boolean o_testCreateBucket_mg2_mg17__37 = __DSPOT_o_429.equals(__DSPOT_o_433);
        org.junit.Assert.assertFalse(o_testCreateBucket_mg2_mg17__37);
    }
