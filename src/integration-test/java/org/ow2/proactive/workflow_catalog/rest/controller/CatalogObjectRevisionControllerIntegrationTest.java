...
public class CatalogObjectRevisionControllerIntegrationTest extends AbstractWorkflowRevisionControllerTest {
    ...
    public void setup() throws IOException {
        ...
        firstWorkflowRevision = workflowRevisionService.createWorkflowRevision(bucket.getId(),
                                                                               Optional.empty(),
        ...
        workflowRevisionAlone = workflowRevisionService.createWorkflowRevision(bucket.getId(),
                                                                               Optional.empty(),
                                                                               IntegrationTestUtil.getWorkflowAsByteArray("workflow.xml"),
                                                                               Optional.empty());
    }
