...
public class WorkflowCatalogQueryLanguageVisitorTest {
    ...
    public void testGetTableVariable() throws Exception {
        assertEquals(ClauseKey.TABLE.VARIABLE, queryLanguageVisitor.getTable("variable.name"));
        assertEquals(ClauseKey.TABLE.VARIABLE, queryLanguageVisitor.getTable("VARIABLE.NAME"));
    }

    @Test
    public void testGetTableGI() throws Exception {
        assertEquals(ClauseKey.TABLE.GENERIC_INFORMATION, queryLanguageVisitor.getTable("generic_information.name"));
        assertEquals(ClauseKey.TABLE.GENERIC_INFORMATION, queryLanguageVisitor.getTable("GENERIC_INFORMATION.NAME"));
    }

    @Test
    public void testGetTableName() throws Exception {
        assertEquals(ClauseKey.TABLE.NAME, queryLanguageVisitor.getTable("name"));
        assertEquals(ClauseKey.TABLE.NAME, queryLanguageVisitor.getTable("NAME"));
    }

    @Test
    public void testGetTableProjectName() throws Exception {
        assertEquals(ClauseKey.TABLE.PROJECT_NAME, queryLanguageVisitor.getTable("project_name"));
        assertEquals(ClauseKey.TABLE.PROJECT_NAME, queryLanguageVisitor.getTable("PROJECT_NAME"));
    }

    @Test
    public void testGetOperation() throws Exception {
        assertEquals(ClauseKey.OPERATION.EQUAL, queryLanguageVisitor.getOperation("="));
        assertEquals(ClauseKey.OPERATION.NOT_EQUAL, queryLanguageVisitor.getOperation("!="));
    }
