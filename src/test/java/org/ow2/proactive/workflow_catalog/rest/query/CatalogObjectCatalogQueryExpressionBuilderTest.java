...
public class CatalogObjectCatalogQueryExpressionBuilderTest {
    ...
    public void setUp() throws Exception {
        ...
        WorkflowCatalogQueryLanguageParser.StartContext context = mock(WorkflowCatalogQueryLanguageParser.StartContext.class);
        when(queryCompiler.compile(anyString())).thenReturn(context);
    }

    @Test
    public void testBuildWithEmptyQuery() throws Exception {
        expressionBuilder = new WorkflowCatalogQueryExpressionBuilder("", queryCompiler, queryListener, walker);
