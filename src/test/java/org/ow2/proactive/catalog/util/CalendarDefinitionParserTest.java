...
public class CalendarDefinitionParserTest {

    private AbstractCatalogObjectParser parser = new CalendarDefinitionParser();

    private SupportedParserKinds kind = SupportedParserKinds.CALENDAR;
