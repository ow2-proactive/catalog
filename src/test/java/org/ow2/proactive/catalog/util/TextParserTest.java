...
import org.ow2.proactive.catalog.util.parser.TextParser;
...
public class TextParserTest {
    ...
    private AbstractCatalogObjectParser parser = new TextParser();

    private SupportedParserKinds kind = SupportedParserKinds.TEXT;
