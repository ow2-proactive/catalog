...
import org.ow2.proactive.catalog.rest.query.SyntaxException;


/**
 * Unit tests associated to {@link CatalogQueryCompiler}.
 * <p>
...
public class CatalogObjectCatalogQueryCompilerTest {
    ...
    private final CatalogQueryCompiler compiler;
    ...
    public static Collection<Assertion> queriesUnderTest() {
        return Arrays.asList(new Assertion[] {
                                               ...
                                               validTestInput("name=\"\""), validTestInput("name=\"value\""),
                                               ...
                                               validTestInput("name=\"*suffix\""), validTestInput("name=\"prefix*\""),
                                               ...
                                               validTestInput("generic_information(\"name1\", \"value1\") " +
                                               ...
                                               validTestInput("variable(\"name1\", \"value1\") " +
                                               ...
                                               validTestInput("variable(\"name1\", \"value1\") " +
                                                              "AND generic_information(\"name2\", \"value2\") " +
                                                              "OR variable(\"name3\", \"value3\")"),
                                               validTestInput("name=\"name1\" AND variable(\"name1\", \"value1\") " +
                                                              "AND generic_information(\"name2\", \"value2\") " +
                                                              "OR variable(\"name3\", \"value3\")"),
                                               ...
                                               invalidTestInput("name=\'value\'"), invalidTestInput("name==\"value\""),
                                               invalidTestInput("name<>\"value\""), invalidTestInput("name=value"),
                                               invalidTestInput("name=(value)"), invalidTestInput("name(value)"),
    ...
    public CatalogObjectCatalogQueryCompilerTest(Assertion assertion) {
        this.compiler = new CatalogQueryCompiler();
    ...
    public void testQuery() {
        try {
            ...
            if (!assertion.shouldPass) {
                Assert.fail(getMessageDump(assertion, "Query is detected as syntactically correct but it should not"));
            }
        } catch (SyntaxException e) {
            if (assertion.shouldPass) {
                Assert.fail(getMessageDump(assertion,
                                           e,
                                           "Query is detected as syntactically incorrect but it should not"));
            }
        }
    }
