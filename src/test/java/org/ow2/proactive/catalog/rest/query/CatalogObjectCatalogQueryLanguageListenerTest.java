...
/**
 * Unit and functional tests associated to {@link CatalogQueryLanguageListener}.
 *
...
public class CatalogObjectCatalogQueryLanguageListenerTest {
    ...
    private CatalogQueryLanguageListener listener;

    @Before
    public void setUp() {
        listener = new CatalogQueryLanguageListener();
    }
    ...
    public void testWalkOnValidQuery() throws SyntaxException {
        CatalogQueryCompiler queryCompiler = new CatalogQueryCompiler();
        ...
        CatalogQueryLanguageParser.StartContext context = queryCompiler.compile(query);
