...
public final class AtomicLexicalClause {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equal(hasWildcards, that.hasWildcards) && Objects.equal(operator, that.operator) &&
    ...
    public String toString() {
        return "AtomicLexicalClause{" + "type=" + type + ", operator=" + operator + ", hasWildcards=" + hasWildcards +
               '}';
    }
