 ...
 */
public interface CatalogObjectRevisionRepository extends CrudRepository<CatalogObjectRevisionEntity, Long>,
    ...
    List<CatalogObjectRevisionEntity> getRevisions(Long catalogObjectId);
